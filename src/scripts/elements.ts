...
export function getLaneEditingHTML(id: string, bpm: number, measureCount: number, hitsound: string, metronomeSound: string, precision: string, initialMaxMeasureCount: number): string {
    ...
    <div class="lane_editing">
        ...
        <div class="metronome_container">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="lucide lucide-list-music"><path d="M21 15V6"/><path d="M18.5 18a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"/><path d="M12 12H3"/><path d="M16 6H3"/><path d="M12 18H3"/></svg>
            </button>
        ...
        <div class="lane_loading_container">
            <select class="load_lane_select" id="${id}_load_select">
            </select>
            <div class="load_lane_buttons"> 
                <input type="text" class="lane_name" placeholder="lane name" id="${id}_lane_name"></input>
                <button class="save_lane" id="${id}_save_lane_button">Save lane</button>
                <button class="load_lane" id="${id}_load_lane_button">Load lane</button>
            </div>
